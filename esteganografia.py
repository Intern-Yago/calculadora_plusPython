...
class funcoes:
    ...
    def easter_egg(argumentos):
        try:
            ...
            print("Talvez você esteja se perguntado o porquê do nome deste programa ou qual sua funcionalidade.\n"
                  ...
                  "Eu sei que poderia ser qualquer outra coisa, mas preferi uma calculadora em homenagem aos"
                  "apps que utilizei no cel para atos semelhantes, enfim, espero que lhe sirva\n\n\n"
                  "~Feito por: 5H4D0W")
    ...
    def checagem_argumentos(argumentos):
        ...
        if "?h" in argumentos or "?help" in argumentos:
            funcoes.ajuda()
        return {"file": file, "insercao": insercao}
